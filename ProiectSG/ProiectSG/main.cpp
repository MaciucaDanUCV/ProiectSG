...
float bloc_height = 55;//y=10;



float bloc2_size = 20; //x=z=10
float bloc2_height = 90;//y=10;
float casa1_size = 20; //x=z=10
float casa1_height = 20;//y=10;
float casa2_size = 20; //x=z=10
float casa2_height = 17;//y=10;
...
RECT rect;
RECT rectenv;
bool okStrada = true; //nu a iesit de pe strada
...
{
	float tree_size = 20.0f; //pe latime
	float tree_height = 20.0f; //inaltimea
...
void loadTexture(void)
{
	...
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Grass.jpg", &g_pTexture[nTexture]);//1
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Road2.jpg", &g_pTexture[nTexture]);//2
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Road1.jpg", &g_pTexture[nTexture]);//3
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/SkyTop.jpg", &g_pTexture[nTexture]);//4
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/SkyRight.jpg", &g_pTexture[nTexture]);//5
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/SkyLeft.jpg", &g_pTexture[nTexture]);//6
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/SkyFront.jpg", &g_pTexture[nTexture]);//7
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/SkyBack.jpg", &g_pTexture[nTexture]);//8
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Bloc1.png", &g_pTexture[nTexture]);//9
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Tree.png", &g_pTexture[nTexture]);//10
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Plane.png", &g_pTexture[nTexture]);//11
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Bloc2.png", &g_pTexture[nTexture]);//12
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Casa1.png", &g_pTexture[nTexture]);//13
	nTexture++;
	D3DXCreateTextureFromFile(g_pd3dDevice, L"Texture/Casa2.png", &g_pTexture[nTexture]);//14
	nTexture++;
...
bool ePeStrada()
{
	if ((eye_vector.x<120 || eye_vector.x>380) || (eye_vector.z<120 || eye_vector.z>380)) return true;
	else return false;
}
...
void render(void)
{
	...
	if (ePeStrada()) { m_font->DrawText(NULL, L"Playerul se afla pe strada!", -1, &rect, 0, D3DCOLOR_ARGB(255, 0, 0, 255)); }
	else { m_font->DrawText(NULL, L"Playerul a iesit de pe strada!", -1, &rect, 0, D3DCOLOR_ARGB(255, 255, 0, 0)); }
